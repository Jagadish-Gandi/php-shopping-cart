...
<body>
  ...
  echo $_SESSION['message'];
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <form action="action.php" method="POST" class="qty-update-form">
    ...
    <input type="number" class="form-control itemQty" name="qty" value="<?= $row['qty'] ?>" style="width:100px;" min='0'>
    <input type="submit" class="qty-update-btn" name="qty_update" value="Update">
</form>
